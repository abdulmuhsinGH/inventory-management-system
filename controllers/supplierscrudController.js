"use strict";
app.controller("supplierscrudController", function($scope, $location){

	$scope.table_name = "suppliers";
	...
	$scope.save = function(){
		...
		$scope.form = {};
		$scope.list();
		$('#supplierscrudController').modal('hide');
	}
	...
	$scope.edit = function(data){
		$scope.form = data;
		$('#supplierscrudController').modal('show');
	}
