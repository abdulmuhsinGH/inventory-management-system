"use strict";
app.controller("inventoriescrudController", function($scope, $location){

	$scope.table_name = "inventories";
	...
	$scope.save = function(){
		...
		$scope.form = {};
		$scope.list();
		$('#inventoriescrudController').modal('hide');
	}
	...
	$scope.edit = function(data){
		$scope.form = data;
		$('#inventoriescrudController').modal('show');
	}
