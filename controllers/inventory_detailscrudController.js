"use strict";
app.controller("inventory_detailscrudController", function($scope, $location){

	$scope.table_name = "inventory_details";
	...
	$scope.save = function(){
		...
		$scope.form = {};
		$scope.list();
		$('#inventory_detailscrudController').modal('hide');
	}
	...
	$scope.edit = function(data){
		$scope.form = data;
		$('#inventory_detailscrudController').modal('show');
	}
