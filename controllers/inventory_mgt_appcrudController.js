"use strict";
app.controller("inventory_mgt_appcrudController", function($scope, $location){
	...
	$scope.save = function(){
		...
		$scope.form = {};
		$scope.list();
		$('#inventory_mgt_appcrudController').modal('hide');
	}
	...
	$scope.edit = function(data){
		$scope.form = data;
		$('#inventory_mgt_appcrudController').modal('show');
	}
