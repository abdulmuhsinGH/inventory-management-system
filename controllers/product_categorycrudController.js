"use strict";
app.controller("product_categorycrudController", function($scope, $location){

	$scope.table_name = "product_categories";
	...
	$scope.save = function(){
		...
		$scope.form = {};
		$scope.list();
		$('#product_categorycrudController').modal('hide');
	}
	...
	$scope.edit = function(data){
		$scope.form = data;
		$('#product_categorycrudController').modal('show');
	}
