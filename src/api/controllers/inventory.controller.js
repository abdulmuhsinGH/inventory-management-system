...
var _insertInventory = function(req, res, inventory, product){
	...
	db.serialize(function () {
	  ...
	  var date = new Date();  
	    ...
	    stmt.run(inventory.product_id, inventory.supplier_id, inventory.cost_price, inventory.selling_price, inventory.quantity, inventory.current_cost_price, inventory.current_selling_price, productTotalQuantity, currentDateTime, currentDateTime);
